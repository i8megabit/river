...
Эта папка описывает работу платформы в терминах Glacier и River. Glacier собирает данные в Catchment и сбрасывает Melt в S3. River через Flow Ingestion принимает Melt и показывает его в Delta View.
